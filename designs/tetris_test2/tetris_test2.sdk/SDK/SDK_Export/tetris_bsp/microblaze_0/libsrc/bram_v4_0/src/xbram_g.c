...
XBram_Config XBram_ConfigTable[] =
{
	...
	{
		XPAR_AXI_BRAM_AI_CNTRL_DEVICE_ID,
		XPAR_AXI_BRAM_AI_CNTRL_DATA_WIDTH,
		XPAR_AXI_BRAM_AI_CNTRL_ECC,
		XPAR_AXI_BRAM_AI_CNTRL_FAULT_INJECT,
		XPAR_AXI_BRAM_AI_CNTRL_CE_FAILING_REGISTERS,
		0,
		XPAR_AXI_BRAM_AI_CNTRL_UE_FAILING_REGISTERS,
		0,
		XPAR_AXI_BRAM_AI_CNTRL_ECC_STATUS_REGISTERS,
		XPAR_AXI_BRAM_AI_CNTRL_CE_COUNTER_WIDTH,
		XPAR_AXI_BRAM_AI_CNTRL_ECC_ONOFF_REGISTER,
		XPAR_AXI_BRAM_AI_CNTRL_ECC_ONOFF_RESET_VALUE,
		XPAR_AXI_BRAM_AI_CNTRL_WRITE_ACCESS,
		XPAR_AXI_BRAM_AI_CNTRL_S_AXI_BASEADDR,
		XPAR_AXI_BRAM_AI_CNTRL_S_AXI_HIGHADDR,
		XPAR_AXI_BRAM_AI_CNTRL_S_AXI_CTRL_BASEADDR,
		XPAR_AXI_BRAM_AI_CNTRL_S_AXI_CTRL_HIGHADDR
	}
};
